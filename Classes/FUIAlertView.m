...
//  Customized by Keisuke Uchida on 15/7/13.
...
NSInteger const CONST_BUTTON_MODE_DEFAULT = 0;
NSInteger const CONST_BUTTON_MODE_CANCEL = 1;
  ...
  otherButtonTitles:(NSString *)otherButtonTitles, ... {
    ...
    if (self) {
        ...
        for (NSString *arg = otherButtonTitles; arg != nil; arg = va_arg(args, NSString*)) {
            [self addButtonWithTitle:arg mode:CONST_BUTTON_MODE_DEFAULT];
        }
        va_end(args);
        [self addButtonWithTitle:cancelButtonTitle mode:CONST_BUTTON_MODE_CANCEL];
    }
    return self;
}
...
- (NSInteger)addButtonWithTitle:(NSString *)title mode:(NSInteger)mode {
    UIColor* buttonColor;
    UIColor* buttonShadowColor;
    UIColor* buttonTitleColor;
    UIFont* buttonFont;
    
    if(CONST_BUTTON_MODE_CANCEL == mode) {
        buttonColor = _cancelButtonColor;
        buttonShadowColor = _cancelButtonShadowColor;
        buttonTitleColor = _cancelButtonTitleColor;
        buttonFont = _defaultButtonFont;
    } else {
        buttonColor = _defaultButtonColor;
        buttonShadowColor = _defaultButtonShadowColor;
        buttonTitleColor = _defaultButtonTitleColor;
        buttonFont = _defaultButtonFont;
    }
    ...
    button.shadowColor = buttonShadowColor;
...
- (void) setCancelButtonTitleColor:(UIColor *)defaultButtonTitleColor {
    _cancelButtonTitleColor = defaultButtonTitleColor;
}

- (void) setCancelButtonColor:(UIColor *)defaultButtonColor {
    _cancelButtonColor = defaultButtonColor;
}

- (void) setCancelButtonShadowColor:(UIColor *)defaultButtonShadowColor {
    _cancelButtonShadowColor = defaultButtonShadowColor;
}
