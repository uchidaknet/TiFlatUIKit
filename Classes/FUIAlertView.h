...
extern const NSInteger CONST_BUTTON_MODE_DEFAULT;
extern const NSInteger CONST_BUTTON_MODE_CANCEL;
...
- (NSInteger)addButtonWithTitle:(NSString *)title mode:(NSInteger)mode;    // returns index of button. 0 based.
...
@property(nonatomic, strong) UIColor *cancelButtonShadowColor;
